...
const breadcrumbs: BreadcrumbItem[] = [
    {
        ...
        href: '/technician/settings/profile',
    },
];
...
export default function Profile({
    ...
    const technicianUser = page.props.technician as
        | {
              user: {
                  name: string;
                  email: string;
    ...
    const submit: FormEventHandler = (e) => {
        ...
        patch(route('technician.profile.update'), {
            preserveScroll: true,
        });
    };
