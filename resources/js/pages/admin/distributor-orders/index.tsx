...
export default function AdminDistributorOrdersIndex() {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <ButtonCreate
                href={route('admin.distributor-orders.create')}
                text="Place distributor order"
            />
                            ...
                            <tr key={row.id} className="border-t border-gray-200">
                                <td className="p-3">
                                    <a
                                        ...
                                        href={route('admin.distributor-orders.show', row.id)}
                                    >
                                        {row.order_number}
                                    </a>
                                </td>
