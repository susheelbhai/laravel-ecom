...
export default function StockMovementByProduct() {
    const { product, movements: data } = usePage<SharedData>().props as any;
                ...
                <div className="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p className="mt-2 text-sm text-gray-500">
                            Viewing all stock movements for this product
                        </p>
                    </div>
                </div>
            </div>
