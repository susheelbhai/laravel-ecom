...
export default function StockMovementByWarehouse() {
    const { warehouse, movements: data } = usePage<SharedData>().props as any;
                ...
                <div className="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p className="mt-2 text-sm text-gray-500">
                            Viewing all stock movements in this warehouse
                        </p>
                    </div>
                </div>
            </div>
            ...
            <TableCard>
                ...
                {items.length === 0 && (
                    <div className="py-12 text-center text-gray-500">
                        No stock movements found in this warehouse.
                    </div>
                )}
