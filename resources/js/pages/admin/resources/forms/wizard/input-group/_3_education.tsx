    ...
    return (
        ...
        >
                    ...
                    <div className="text-right">
                        {courses.length > 1 && (
                            <button
                                ...
                                className="cursor-pointer rounded-sm bg-red-500 px-3 py-1 text-xl text-white hover:bg-red-700"
                            >
                                &times;
                            </button>
                        )}
            ...
            <button
                ...
                className="mt-2 cursor-pointer rounded-md bg-blue-600 px-4 py-2 text-sm text-white hover:bg-blue-800"
            >
                + Add New Course
            </button>
        </InputFieldset>
