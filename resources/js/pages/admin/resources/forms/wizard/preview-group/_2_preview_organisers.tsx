...
export default function PreviewOrganisers({ data }: { data: any }) {
    const organisers = Array.isArray(data.eventOrganisers)
    ...
    const getFileUrl = (file: any): string | null => {
        ...
        if (Array.isArray(data.media)) {
            const mediaFile = data.media.find(
                (m: any) => m.collection_name === 'proof_of_address',
            );
    ...
    return (
        ...
        >
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                <PreviewItem
                    label="Organization / Legal Entity"
            ...
            {organisers.length > 0 && (
                <div>
                    <h3 className="text-md mt-6 mb-2 font-semibold text-gray-700">
                        Event Organisers
                    </h3>
