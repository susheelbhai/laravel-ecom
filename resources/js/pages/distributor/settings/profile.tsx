...
const breadcrumbs: BreadcrumbItem[] = [
    {
        ...
        href: '/distributor/settings/profile',
    },
];
...
export default function Profile({
    ...
    const distributorUser = page.props.distributor as
        | {
              user: {
                  name: string;
                  email: string;
    ...
    const submit: FormEventHandler = (e) => {
        ...
        patch(route('distributor.profile.update'), {
            preserveScroll: true,
        });
    };
