...
const breadcrumbs: BreadcrumbItem[] = [{ title: 'Stock', href: '/distributor/stock' }];

export default function DistributorStockIndex() {
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            {modalData && (
                <SerialsModal
                    ...
                    lookupRoute={route('distributor.serial-numbers.lookup')}
                />
            )}
        </AppLayout>
    );
