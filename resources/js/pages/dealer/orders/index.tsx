...
const breadcrumbs: BreadcrumbItem[] = [{ title: 'My Orders', href: '/dealer/orders' }];

export default function DealerOrdersIndex() {
                            ...
                            <tr key={row.id} className="border-t border-gray-200">
                                <td className="p-3">
                                    <a
                                        ...
                                        href={route('dealer.orders.show', row.id)}
                                    >
                                        {row.order_number}
                                    </a>
                                </td>
                                ...
                                <td className="p-3 text-right">{formatMoney(row.total_amount)}</td>
