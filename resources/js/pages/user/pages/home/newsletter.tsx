...
export default function NewsletterSection() {
    ...
    const appName = (usePage().props as any).appData?.name || 'us';
        ...
        >
            <Container className="text-center">
                ...
                <p className="mb-8 text-muted-foreground">
                    Subscribe to receive the latest updates and offers from
                    {appName}.
                </p>
                ...
                <form onSubmit={submit} className="mx-auto max-w-md">
                    <div className="flex w-full items-stretch overflow-hidden rounded-full border border-primary bg-background">
                        <input
                            ...
                            className="flex-1 border-none bg-transparent px-4 py-2.5 text-sm text-foreground outline-none placeholder:text-muted-foreground focus:ring-0 focus:outline-none"
                        />

                        <Button
                            type="submit"
                            disabled={processing}
                            className="m-0 h-full rounded-none rounded-r-full border-2 border-primary bg-primary px-6 text-sm font-semibold text-primary-foreground hover:border-primary/90 hover:bg-primary/90 focus:border-primary/90 active:border-primary/90"
                        >
