                ...
                <section className="relative h-64 w-full overflow-hidden md:h-80">
                    ...
                    <div className="relative z-10 flex h-full items-center justify-center px-4">
                        <div className="text-center">
                            <span className="inline-flex items-center rounded-full bg-white/10 px-3 py-1 text-xs font-semibold tracking-[0.16em] text-white/80 uppercase">
                                Know our story
                            </span>
                            ...
                            <p className="mx-auto mt-3 max-w-2xl text-sm text-white/80 md:text-base">
                                Learn more about who we are, what drives us, and
                                the vision that shapes everything we do.
                            </p>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="rounded-3xl bg-card/90 p-6 shadow-[0_24px_60px_rgba(0,0,0,0.08)] ring-1 ring-border md:p-8 lg:p-10">
                        ...
                        <div className="mt-10 border-t border-border pt-8">
                            ...
                            <div className="grid gap-6 md:grid-cols-3">
                                ...
                                <div className="group rounded-2xl bg-muted p-5 shadow-sm ring-1 ring-border transition hover:-translate-y-1 hover:shadow-md">
                                    ...
                                    <div className="prose prose-sm prose-p:mb-2 prose-ul:mb-2 max-w-none text-muted-foreground">
                                        <div
                        ...
                        <div className="mt-12 rounded-3xl bg-muted p-6 ring-1 ring-border md:flex md:items-center md:gap-8 md:p-7 lg:p-8">
                            ...
                            <div className="relative flex-1">
                                <div className="mb-3 inline-flex items-center gap-2 rounded-full bg-primary/5 px-3 py-1 text-[11px] font-semibold tracking-[0.18em] text-muted-foreground uppercase">
