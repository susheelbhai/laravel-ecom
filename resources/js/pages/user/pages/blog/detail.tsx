        ...
        <AppLayout title={blog.title}>
            <div className="bg-background text-foreground">
                ...
                <div
                    ...
                    style={{ backgroundImage: `url('${blog.display_img}')` }}
                >
                    <div className="flex h-full w-full items-center justify-center bg-black/40 dark:bg-black/70">
                        <h1 className="text-4xl font-bold text-primary-foreground md:text-5xl dark:text-white dark:drop-shadow-lg">
                            {blog.title}
                        </h1>
                    </div>
                </div>
