...
export default function ContinueWithSocial({
    ...
    switch (platform) {
        case 'google':
            return (
                <ContinueWithGoogle
                    href={href ?? route('social.login', 'google')}
                />
            );
        case 'facebook':
            return (
                <ContinueWithFacebook
                    href={href ?? route('social.login', 'facebook')}
                />
            );
        case 'x':
        ...
        case 'linkedin':
            return (
                <ContinueWithLinkedIn
                    href={href ?? route('social.login', 'linkedin')}
                />
            );
        case 'github':
            return (
                <ContinueWithGitHub
                    href={href ?? route('social.login', 'github')}
                />
            );
        case 'gitlab':
            return (
                <ContinueWithGitLab
                    href={href ?? route('social.login', 'gitlab')}
                />
            );
        case 'bitbucket':
            return (
                <ContinueWithBitbucket
                    href={href ?? route('social.login', 'bitbucket')}
                />
            );
        case 'slack':
            return (
                <ContinueWithSlack
                    href={href ?? route('social.login', 'slack')}
                />
            );
        case 'apple':
            return (
                <ContinueWithApple
                    href={href ?? route('social.login', 'apple')}
                />
            );
        case 'amazon':
            return (
                <ContinueWithAmazon
                    href={href ?? route('social.login', 'amazon')}
                />
            );
        default:
            return null;
