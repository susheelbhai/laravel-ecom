        ...
        <InputWrapper>
            ...
            <div className="relative">
                <div className="relative w-full">
                    <input
                        type="text"
                        className={`w-full rounded-lg border-2 border-input-border bg-input-bg px-3 py-2 text-left text-input-text placeholder:text-input-placeholder hover:bg-input-hover-bg focus:border-secondary/60 focus:bg-input-focused-bg focus:text-input-focused-text focus:outline-none ${className || ''}`}
                        value={value}
                ...
                {isOpen && (
                    <div className="clock-popover absolute left-0 z-10 mt-2 rounded-lg border bg-background p-4 shadow-lg">
                        ...
                        {value && <div className="selected-time">{value}</div>}
                    </div>
                )}
            </div>
        </InputWrapper>
