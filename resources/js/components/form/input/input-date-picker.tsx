            ...
            <div className="relative w-full">
                ...
                <div className="relative">
                    <Input
                        ...
                        readOnly={readOnly}
                        className="border-input-border bg-input-bg pr-10 text-input-text placeholder:text-input-placeholder hover:bg-input-hover-bg focus:bg-input-focused-bg focus:text-input-focused-text"
                        maxLength={10}
                    />
