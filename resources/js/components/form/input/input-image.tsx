        ...
        <InputWrapper className={className}>
            ...
            <div className="space-y-2">
                ...
                <div
                    ...
                    onDrop={handleDrop}
                    className={`relative flex cursor-pointer items-center justify-center overflow-hidden rounded-md border-2 border-dashed border-input-border bg-input-bg hover:bg-input-hover-bg ${
                        dragging ? 'border-secondary bg-input-focused-bg' : ''
                    }`}
