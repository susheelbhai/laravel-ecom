        ...
        <InputWrapper className={className}>
            ...
            <div className="space-y-2">
                ...
                <input
                    ...
                    className="w-full rounded-md border-2 border-input-border bg-input-bg px-3 py-2 text-sm text-input-text placeholder:text-input-placeholder hover:bg-input-hover-bg focus:border-secondary/60 focus:bg-input-focused-bg focus:text-input-focused-text focus:outline-none"
                />
            </div>
