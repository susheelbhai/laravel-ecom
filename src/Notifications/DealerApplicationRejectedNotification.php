...
class DealerApplicationRejectedNotification extends Notification
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ->subject('Update on your dealer account')
            ->markdown('mail.dealer.application-rejected', [
                'dealer' => $this->dealer,
    ...
    {
        return [
            'type' => 'dealer_application_rejected',
            'title' => 'Dealer account not approved',
            'url' => route('dealer.login'),
            'data' => [
