...
class SettingController extends Controller
{
    ...
    public function generalSettingsUpdate(UpdateGeneralSettingsRequest $req)
    {
        ...
        if ($req->hasFile('square_dark_logo')) {
            $faviconFile = $req->file('square_dark_logo');
            ...
            $setting->clearMediaCollection('square_dark_logo');
            $setting->addMediaFromRequest('square_dark_logo')->toMediaCollection('square_dark_logo');
        }
        ...
        if ($req->hasFile('square_light_logo')) {
            $setting->clearMediaCollection('square_light_logo');
            $setting->addMediaFromRequest('square_light_logo')
                ->toMediaCollection('square_light_logo');
        }
